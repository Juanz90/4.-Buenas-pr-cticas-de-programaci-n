...
/*Crea una variable llamada "valor1" y otra llamada "valor2", asignándoles valores numéricos de tu elección. 
Luego, realiza la resta de estos dos valores y almacena el resultado en una tercera variable llamada "resultado". Utiliza console.log para mostrar el mensaje "La diferencia entre [valor1] y [valor2] es igual a [resultado]." en la consola.
*/
let Valor1 = 7;
let Valor2 = 6;
let Resultado = (Valor1 - Valor2);
...
*/
let numeroUsuario = prompt('Ingrese un número negativo o positivo: ');
    if(numeroUsuario < 0) {
...
/*Crea una variable "nota" y asígnale un valor numérico.
 Utiliza un if-else para determinar si la nota es mayor o igual a 7 y muestra "Aprobado" o "Reprobado" 
 en la consola.
*/
let nota = 8;
    if (nota >= 7){
...
*/
let numeroAleat = Math.floor(Math.random()*1000)+1;
